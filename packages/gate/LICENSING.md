...
| Receipt format and signature suite           | Specification, [`docs/RECEIPTS.md`](https://github.com/11-11AI/execution-governance/blob/main/docs/RECEIPTS.md) | Apache-2.0, permanent | Yes             | No         |
